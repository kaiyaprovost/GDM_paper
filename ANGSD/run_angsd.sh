...
spp="bellii"
ref=Corv_chrom/pseudochromosomesSHORT.fasta
bamlist=${spp}.bamlist
names=#####
...
for clippedbam in *${spp}*.clipped.bam; do
	...
	echo "#######################"
	echo Indel Realigner
	time java -jar GenomeAnalysisTK-3.8-1-0-gf15c1c3ef/GenomeAnalysisTK.jar \
	-T IndelRealigner \
	-R $ref \
	-I $clippedbam \
	-targetIntervals ${spp}-allsamplesClipped-final.intervals \
